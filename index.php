...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	CURLOPT_URL => 'localhost:8080/api/usuarios',
	...
	curl_setopt_array($curl, array(
	CURLOPT_URL => 'localhost:8080/api/token',
	CURLOPT_RETURNTRANSFER => true,
	CURLOPT_ENCODING => '',
	CURLOPT_MAXREDIRS => 10,
	CURLOPT_TIMEOUT => 0,
	...
	CURLOPT_POSTFIELDS =>'{
		...
		"llave_secreta": "'. $data1->email. $data1->nombres. $data1->apellidos. '"
	}',
	CURLOPT_HTTPHEADER => array(
		'Content-Type: application/json'
	),

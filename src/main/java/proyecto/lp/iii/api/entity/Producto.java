...
public class Producto {
    ...
    public String toString() {
        return "Producto [id_productos=" + id_productos + ", id_tenants=" + id_tenants + ", id_categorias_productos="
                ...
                + ", contenido_neto=" + contenido_neto + ", precio_costo=" + precio_costo + ", precio_venta="
                + precio_venta + ", margen_ganancia=" + margen_ganancia + ", stock_minimo=" + stock_minimo
                + ", stock_critico=" + stock_critico + ", visible_storefront=" + visible_storefront
